...
const Sidebar = ({
  ...
  return (
    <ContainerSider clickMenu={expand}>
      <SiderCustom
        width={maxWidth}
        ...
        collapsed={!expand}
        onMouseEnter={() => {
          setExpand(isExpand ? expand : !expand);
          onHoverLogo(isExpand ? expand : !expand);
        }}
        onMouseLeave={() => {
          setExpand(isExpand ? expand : false);
          onHoverLogo(isExpand ? expand : false);
        }}
      >
        <div>
          <TopSidebar>
            <IconMenu
              ...
              onClick={() => {
                onClickLogoMenu();
                onHoverLogo(isExpand ? false : expand);
              }}
