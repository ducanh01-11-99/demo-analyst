...
import SidebarNotHover from './components/SidebarNotHover/index';
import HeaderNotHover from './components/HeaderNotHover/index';
      ...
      {process.env.COLLAPSE_HOVER ? (
        <>
          <Sidebar
            ...
            iconMenu={iconMenu}
            logo={iconLogo}
            onClickLogoMenu={() => setMenuExpand(!menuExpand)}
            onClickLogo={() => navigate('/')}
            onHoverLogo={bool => setExpand(bool)}
          />
          {contextHolder}
